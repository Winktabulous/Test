...
public enum LeagueTaskVarps
{
	...
	@Getter
	private static final HashMap<Integer, LeagueTaskVarps> idToVarpMap = new HashMap<>();
	...
	static
	{
		for (LeagueTaskVarps varp : LeagueTaskVarps.values())
		{
